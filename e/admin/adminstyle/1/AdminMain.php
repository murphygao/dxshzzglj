...
<td height="60">
  ...
  <form name="menuform" id="menuform">
	...
	<input type="hidden" name="onclickmenu" value="">
      <TR>
            <TD width="180"><div align="center"><a href="main.php<?=$ecms_hashur['whehref']?>" target="main" title="<?php echo backendSiteName?>"><span style="color:#fff;font-size: 24px;font-weight: bold;"><?php echo backendLogo?></span></a></div></TD>
		<TD height="60">
              ...
              <TABLE class=flyoutMenu border=0>
                <TBODY>
                  <TR align=middle>
                    ...
                    <TD style="display:none;"  width="60" class="flyoutLink" onclick="window.open('http://bbs.phome.net/listthread-23-cms-page-0.html');" onmouseover="over(this)" onmouseout="out(this)">版本更新</TD>
                  </TR>
                </TBODY>
              </TABLE>
            </TD>
